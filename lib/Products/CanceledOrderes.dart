...
class _CanceledOrdersState extends State<CanceledOrders> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: ref.doc(_auth.currentUser!.uid).collection('Canceled Orders').orderBy('orderId',descending: true).snapshots(),
            ...
            return Center(child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text("No canceled orders found. Orders you cancel will appear here.",textAlign: TextAlign.center,
                                ...
                                children: [
                                  ...
                                  const Row(
                                    children: [
                                      Text("Order Status:"),
                                      SizedBox(width: 10,),
                                      Text("Canceled",style: TextStyle(color: Colors.red,fontWeight: FontWeight.w500),),
                                    ],
                                  )
                                ],
                              ),
